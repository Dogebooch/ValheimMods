# Missing Items to Monster Mapping (Standardized Format)
...
## FORMAT: POWER_LEVEL_TIERS
```
TIER_1: 5-20 (Early game items - Wood, Flint, Bronze)
TIER_2: 23-35 (Mid-early game items - Iron, Silver, basic magic)
TIER_3: 35-50 (Mid game items - Silver, Black Metal, advanced magic)
TIER_4: 50-70 (Late game items - Black Metal, Mistlands materials)
TIER_5: 70-95 (End game items - Flametal, Ashlands materials)
TIER_6: 95+ (Ultimate items - Divine materials, boss drops)
```

## FORMAT: MONSTER_TIERS
```
TIER_1_MONSTERS:
...
## FORMAT: ITEM_MAPPINGS
```
MOD: Armory
TIER_RANGE: 2-4
DESCRIPTION: Mid-tier equipment requiring materials from Tier 2-4 monsters
RECOMMENDED_DROPS:
- Tier 2: Greydwarf Brute, Draugr Elite, Frost Troll, Wolf
- Tier 3: Fenring, Cultist, Wraith, Serpent
- Tier 4: Goblin Brute, Goblin Shaman, Lox, Deathsquito
MAPPINGS:
...
MOD: BiomeLords
TIER_RANGE: 1-3
DESCRIPTION: Lower tier with some mid-tier options
RECOMMENDED_DROPS:
- Tier 1: Greydwarf, Skeleton, Boar
- Tier 2: Greydwarf Brute, Draugr Elite, Wolf
- Tier 3: Fenring, Cultist, Stone Golem
MAPPINGS:
...
MOD: Hugos Armory
TIER_RANGE: 1-4
DESCRIPTION: Spans from basic to advanced equipment
RECOMMENDED_DROPS:
- Tier 1: Boar, Greydwarf, Skeleton
- Tier 2: Greydwarf Brute, Draugr Elite, Frost Troll
- Tier 3: Fenring, Cultist, Wolf
- Tier 4: Goblin Brute, Lox, Deathsquito
MAPPINGS:
...
MOD: MagicRevamp
TIER_RANGE: 1-3
DESCRIPTION: Magical equipment and staves
RECOMMENDED_DROPS:
- Tier 1: Greydwarf Shaman, Skeleton, Boar
- Tier 2: Draugr, Abomination, Wraith
- Tier 3: Cultist, Stone Golem, Wolf
MAPPINGS:
...
MOD: PlanBuild
TIER_RANGE: 1
DESCRIPTION: Basic building tools
MAPPINGS:
PlanHammer -> Greydwarf (Tier 1, basic tool)

MOD: PotionsPlus
TIER_RANGE: 1-2
DESCRIPTION: Alchemical and magical items
MAPPINGS:
Odins_Alchemy_Wand -> Greydwarf Shaman (Tier 1, magical item)
Odins_Dragon_Staff -> Dragon Queen (Tier 5, requires Dragon materials)

MOD: Shawesomes Divine Armaments
TIER_RANGE: 5-6
DESCRIPTION: High-tier divine equipment requiring powerful materials
RECOMMENDED_DROPS:
- Tier 5: Dragon Queen, Seeker Queen, Gjall
- Tier 6: Surtr variants, Fader, Fallen Valkyrie
MAPPINGS:
...
MOD: SouthsilArmor
TIER_RANGE: 1-5
DESCRIPTION: Wide range of armor from basic to advanced
RECOMMENDED_DROPS:
- Tier 1: Boar, Deer, Skeleton
- Tier 2: Greydwarf Brute, Frost Troll, Draugr Elite
- Tier 3: Fenring, Cultist, Wolf
- Tier 4: Goblin variants, Lox, Deathsquito
- Tier 5: Dragon Queen, Seeker Queen, Gjall
MAPPINGS:
...
MOD: Valheim Enchantment System
TIER_RANGE: 1
DESCRIPTION: Enchantment scrolls and magical items
MAPPINGS:
All enchantment scrolls -> Greydwarf Shaman (Tier 1, magical items)

MOD: WackysDatabase
TIER_RANGE: 1-2
DESCRIPTION: Basic tools and magical staves
MAPPINGS:
...
MOD: Warfare
TIER_RANGE: 1-4
DESCRIPTION: Comprehensive weapon and armor mod with wide tier range
RECOMMENDED_DROPS:
- Tier 1: Greydwarf, Skeleton, Boar
- Tier 2: Greydwarf Brute, Draugr Elite, Frost Troll
- Tier 3: Fenring, Cultist, Wolf, Stone Golem
- Tier 4: Goblin variants, Lox, Deathsquito
MAPPINGS:
...
MOD: Warfare Fire and Ice
TIER_RANGE: 5-6
DESCRIPTION: High-tier equipment requiring advanced materials from Deep North and Ashlands
RECOMMENDED_DROPS:
- Tier 5: Arctic variants, Jotunn variants
- Tier 6: Surtr variants, Gorr
MAPPINGS:
...
MOD: Wizardry
TIER_RANGE: 1-5
DESCRIPTION: Magical equipment spanning from basic to advanced tiers
RECOMMENDED_DROPS:
- Tier 1: Greydwarf Shaman, Skeleton, Boar
- Tier 2: Draugr, Abomination, Wraith
- Tier 3: Cultist, Stone Golem, Wolf
- Tier 4: Goblin Shaman, Lox, Deathsquito
- Tier 5: Seeker Queen, Gjall, Dvergr
MAPPINGS:
...
MOD: Miscellaneous
TIER_RANGE: 1-6
DESCRIPTION: Items whose mod names could not be parsed, but can be mapped based on materials
MAPPINGS:
